...
var PluginManagerApi = class {
	...
	async list() {
		return readJson(await fetch(PLUGIN_MANAGER_API.list));
	}
	...
	async check(names) {
		return readJson(await fetch(PLUGIN_MANAGER_API.check, {
			...
			body: JSON.stringify(names !== void 0 && names.length > 0 ? { names } : {})
		}));
	}
	...
	async updateAll() {
		return (await readJson(await fetch(PLUGIN_MANAGER_API.updateAll, { method: "POST" }))).results;
	}
...
var PluginManagerController = class {
	...
	*/
	async load(forceCheck) {
		...
		if (forceCheck || this.snapshot.plugins.every((entry) => entry.state === "unknown")) await this.check();
	}
	...
	async update(name) {
		...
		if (updating.has(name)) return void 0;
		updating.add(name);
		this.emit({
			updating,
			banner: void 0,
		...
		try {
			...
			this.emit({
				...
				banner: ok ? {
					kind: "ok",
					text: `已更新 ${name}（${result.durationMs < 1e3 ? "不足 1 秒" : `${Math.round(result.durationMs / 1e3)} 秒`}）。重启 DSH 后生效。`
				} : {
					kind: "error",
					text: `更新 ${name} 失败：${result.error ?? "未知错误"}`
				},
	...
	async updateAll() {
		...
		for (const name of targets) {
			...
			if (result?.output !== void 0 && result.output !== "") outputs.push(`$ pnpm → ${name}\n${result.output}`);
		}
		if (anyOk) this.emit({
			banner: {
				kind: "ok",
				text: "批量更新完成。重启 DSH 后新代码生效。"
			},
			needsRestart: true,
	...
	async remove(name) {
		...
		try {
			...
			this.emit({
				...
				banner: ok ? {
					kind: "ok",
					text: `已删除 ${name}。重启 DSH 后完全卸载。`
				} : {
					kind: "error",
					text: `删除 ${name} 失败：${result.error ?? "未知错误"}`
				},
				needsRestart: ok || this.snapshot.needsRestart,
				lastUpdateOutput: result.output
			});
	...
	async reloadAfterUpdate(name) {
		try {
			...
			if (row !== void 0) {
				...
				if (updated !== void 0) rows[rows.indexOf(row)] = updated;
			}
			return rows;
		} catch {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					snapshot.profile !== void 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
						className: "dshpm-badge",
						"data-kind": "info",
						title: snapshot.profile.dir,
						children: ["profile: ", snapshot.profile.name]
					}) : null,
					snapshot.profile?.pnpm !== void 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "dshpm-badge",
						"data-kind": "key",
						title: snapshot.profile.pnpm,
						children: "pnpm ✓"
					}) : snapshot.profile !== void 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "dshpm-badge",
						"data-kind": "fail",
						title: "找不到 pnpm，无法更新",
						children: "pnpm ✗"
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
						...
						children: [
							...
							" 个第三方插件 · 检查源：",
							snapshot.profile?.registry ?? "npm registry",
							" + git"
						]
					})
				]
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: snapshot.loading && snapshot.plugins.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "dshpm-loading",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "dshpm-spinner" }), " 正在读取 profile 插件列表…"]
				}) : snapshot.plugins.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "dshpm-empty",
					children: ["当前 profile 没有通过 pnpm 安装的第三方插件。", /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					] }) }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tbody", { children: snapshot.plugins.map((entry) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PluginRow, {
						entry,
